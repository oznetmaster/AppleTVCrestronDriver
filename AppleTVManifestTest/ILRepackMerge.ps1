...
$libArgs = @("/lib:`"$LibDir`"")
if ($SdkLibDir -and (Test-Path $SdkLibDir)) { $libArgs += "/lib:`"$SdkLibDir`"" }
if ($FxRefDir -and (Test-Path $FxRefDir)) { $libArgs += "/lib:`"$FxRefDir`"" }
if ($FxRuntimeDir -and (Test-Path $FxRuntimeDir)) { $libArgs += "/lib:`"$FxRuntimeDir`"" }
