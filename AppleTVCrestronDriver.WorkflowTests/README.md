# AppleTVCrestronDriver processor workflow
...
```powershell
dotnet test AppleTVCrestronDriver.WorkflowTests/AppleTVCrestronDriver.WorkflowTests.csproj -c Release --list-tests
dotnet test AppleTVCrestronDriver.WorkflowTests/AppleTVCrestronDriver.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.appletvcrestrondriver_driver
```
